...
const BannerTooth = () => {
  return (
    // <div className="relative bg-gradient-to-r from-blue-50 to-cyan-100 py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">  from-[#74c4d0] via-[#62c1d0] to-[#5bc8d4]
    <div className="relative bg-[radial-gradient(ellipse_at_center,_rgba(255,255,255,0.3)_0%,_rgba(116,196,208,0)_70%)] bg-[#74c4d0] py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
