...
const features = [
  {
    ...
    description: 'Utilizamos equipos y técnicas avanzadas para diagnósticos precisos y tratamientos más eficientes.'
  },
  {
    icon: Shield,
    title: 'Excelencia en Cada Detalle',
    description: 'Nos comprometemos con los más altos estándares de calidad y esterilización en todos nuestros procedimientos.'
  },
  {
    icon: Users,
    title: 'Atención Personalizada',
    description: 'Escuchamos tus necesidades y creamos planes de tratamiento individualizados para tu bienestar dental.'
  },
];
